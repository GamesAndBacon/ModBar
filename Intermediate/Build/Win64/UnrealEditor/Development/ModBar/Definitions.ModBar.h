...
#define UE_PROJECT_NAME MultiArenaBrawler
#define UE_TARGET_NAME MultiArenaBrawlerEditor
#define UE_MODULE_NAME "ModBar"
#define UE_PLUGIN_NAME "ModBar"
